...
export default async function GitRoadmapPage() {
    ...
    <div className="space-y-8 py-10">
      <div className="animate-rise">
        ...
        <div className="mt-2 flex flex-wrap items-center gap-3">
          <h1 className="font-display text-3xl font-bold tracking-tight">Lộ trình Git &amp; Công cụ</h1>
          <span className="rounded-full bg-emerald-100 px-3 py-1 text-sm font-semibold text-emerald-700">
            Beta
          </span>
        </div>
        <p className="mt-2 max-w-2xl leading-relaxed text-ink/60">
          Học theo <strong>phần, theo thứ tự</strong>: Git (commit, nhánh, remote) → công cụ dev
      ...
      <p className="text-sm text-ink/50">
        🎉 Trọn bộ 2 Phần: Git → Công cụ dev. Câu bậc 3 chấm tự động bằng cách so chuỗi lệnh bạn gõ
        với các lệnh cốt lõi cần có.
      </p>
    </div>
  );
}
