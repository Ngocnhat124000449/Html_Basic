...
export const ATTRIBUTE_REFLEX_QUESTIONS: AttributeReflexQuestion[] = [
  ...
  // ============ Đợt B: Danh sách & bảng mở rộng ============
  {
    attr: "start",
    tag: "ol",
    prompt: "Bài hướng dẫn bị chèn ảnh giữa chừng làm danh sách tách đôi — phần sau phải đánh số tiếp 4, 5, 6 thay vì quay về 1.",
    explain: 'start="4" cho <ol> thứ hai nối tiếp số thứ tự.',
  },
  {
    attr: "start",
    tag: "ol",
    prompt: "Thuộc tính nào của <ol> nhận MỘT CON SỐ làm điểm bắt đầu đếm thay cho số 1 mặc định?",
    explain: "start đặt số khởi đầu của danh sách.",
  },
  {
    attr: "start",
    tag: "ol",
    prompt: "Trang 2 của 'Top 100 bài hát' bắt đầu từ hạng 51: <ol ___=\"51\">.",
    explain: "start hữu ích khi phân trang danh sách đánh số.",
  },
  {
    attr: "start",
    tag: "ol",
    prompt: "Khác với value đặt trên từng <li>, thuộc tính nào đặt trên CHÍNH <ol> để dời điểm bắt đầu của cả danh sách?",
    explain: "start (trên ol) vs value (trên li từng mục).",
  },
  {
    attr: "type",
    tag: "ol",
    prompt: "Hợp đồng cần đề mục kiểu số La Mã I, II, III — thuộc tính nào của <ol> nhận giá trị 'I'?",
    explain: 'type="I" đánh số La Mã hoa; "i" là la mã thường.',
  },
  {
    attr: "type",
    tag: "ol",
    prompt: "Câu hỏi trắc nghiệm in ra giấy cần đáp án đánh thứ tự A, B, C, D bằng chính HTML.",
    explain: 'type="A" — chữ hoa thứ tự thay số.',
  },
  {
    attr: "type",
    tag: "ol",
    prompt: "Thuộc tính nào của <ol> nhận một trong các giá trị: 1, a, A, i, I?",
    explain: "type chọn kiểu ký hiệu đánh số.",
  },
  {
    attr: "type",
    tag: "ol",
    prompt: "Đề cương 3 cấp: cấp 1 đánh số 1,2,3; cấp 2 lồng bên trong đánh a,b,c — cấp 2 khác cấp 1 ở thuộc tính nào?",
    explain: 'Mỗi <ol> lồng nhau có thể mang type riêng ("a" cho cấp con).',
  },
  {
    attr: "reversed",
    tag: "ol",
    prompt: "Countdown '10 lý do nên học HTML' hiển thị 10, 9, 8... về 1 — thuộc tính boolean nào của <ol>?",
    explain: "reversed đếm ngược — không cần giá trị.",
  },
  {
    attr: "value",
    tag: "li",
    prompt: "Trong danh sách đánh số, mục 'Câu 10' phải mang đúng số 10 dù các câu 7-9 đã bị ẩn đi.",
    explain: 'value="10" trên <li> ép số thứ tự tại mục đó.',
  },
  {
    attr: "value",
    tag: "li",
    prompt: "Thuộc tính nào đặt trên MỘT <li> cụ thể làm thay đổi số của nó và các mục sau đếm tiếp từ đó?",
    explain: "value trên li reset chuỗi số từ vị trí đó.",
  },
  {
    attr: "value",
    tag: "li",
    prompt: "Bảng xếp hạng chỉ hiện hạng 1, 2 rồi nhảy đến hạng 99, 100 — hai mục cuối đặt số đúng bằng thuộc tính nào trên <li>?",
    explain: "value cho phép nhảy cóc số thứ tự giữa danh sách.",
  },
  {
    attr: "colspan",
    tag: "td",
    prompt: "Hàng cuối hóa đơn: ô 'Tổng cộng: 500.000đ' phải chiếm trọn cả 3 cột Tên/SL/Giá gộp làm một.",
    explain: 'colspan="3" gộp ô theo chiều ngang.',
  },
  {
    attr: "colspan",
    tag: "td",
    prompt: "Bảng bị LỆCH CỘT: một hàng có 2 ô trong khi các hàng khác có 3 — ô rộng của hàng đó thiếu thuộc tính khai báo chiếm 2 cột nào?",
    explain: "Thiếu colspan làm số ô các hàng không khớp, bảng xô lệch.",
  },
  {
    attr: "colspan",
    tag: "td",
    prompt: "Dòng 'Không có dữ liệu' phải trải hết bề ngang của bảng 5 cột: <td ___=\"5\">.",
    explain: "colspan=số cột của bảng → ô phủ toàn bộ hàng.",
  },
  {
    attr: "colspan",
    tag: "th",
    prompt: "Tiêu đề nhóm 'Doanh thu 2026' nằm trên và bao trùm 4 cột quý Q1-Q4 — ô <th> đó cần thuộc tính nào?",
    explain: "colspan dùng được cả trên <th> cho tiêu đề nhóm cột.",
  },
  {
    attr: "rowspan",
    tag: "td",
    prompt: "Cột 'Khu vực' ghi 'Miền Bắc' một lần nhưng ô đó phải KÉO DỌC phủ 3 hàng tỉnh bên cạnh.",
    explain: 'rowspan="3" gộp ô theo chiều dọc.',
  },
  {
    attr: "rowspan",
    tag: "td",
    prompt: "Khác colspan (gộp ngang qua cột), thuộc tính nào gộp ô DỌC qua nhiều hàng?",
    explain: "rowspan — row = hàng; colspan — col = cột.",
  },
  {
    attr: "rowspan",
    tag: "td",
    prompt: "Thời khóa biểu: tiết 'Thể dục' kéo dài 2 tiết liên tiếp nên ô của nó phủ 2 hàng — dùng thuộc tính nào?",
    explain: 'rowspan="2" — ô môn học chiếm 2 khung giờ.',
  },
  {
    attr: "scope",
    tag: "th",
    prompt: "Máy đọc màn hình đọc nhầm nhãn hàng thành nhãn cột trong bảng điểm — mỗi <th> cần khai báo rõ phạm vi bằng thuộc tính nào (giá trị col/row)?",
    explain: 'scope="col" / "row" định nghĩa th áp cho cột hay hàng.',
  },
  {
    attr: "scope",
    tag: "th",
    prompt: "Ô <th>Tháng 1</th> đứng ĐẦU HÀNG (không phải đầu cột) — đánh dấu đúng vai trò bằng thuộc tính nào giá trị row?",
    explain: 'scope="row" cho th làm nhãn của hàng.',
  },
  {
    attr: "scope",
    tag: "th",
    prompt: "Audit accessibility yêu cầu mọi <th> phải có thuộc tính chỉ rõ 'tiêu đề này của cột hay của hàng'. Thuộc tính nào?",
    explain: "scope là yêu cầu chuẩn WCAG cho bảng dữ liệu.",
  },
  {
    attr: "scope",
    tag: "th",
    prompt: "Thuộc tính nào CHỈ có nghĩa trên <th> (vô nghĩa trên <td>) và nhận các giá trị col, row, colgroup, rowgroup?",
    explain: "scope — khai báo phạm vi của ô tiêu đề.",
  },
  {
    attr: "headers",
    tag: "td",
    prompt: "Bảng 2 tầng tiêu đề phức tạp: mỗi ô dữ liệu phải liệt kê id của TẤT CẢ các <th> liên quan để máy đọc màn hình nối đúng.",
    explain: "headers liệt kê id các th — dùng khi scope không đủ.",
  },
  {
    attr: "abbr",
    tag: "th",
    prompt: "Cột 'Số lượng tồn kho khả dụng' được máy đọc màn hình đọc lại MỖI Ô rất dài dòng — cho nó bản rút gọn 'Tồn' bằng thuộc tính nào trên th?",
    explain: "abbr cung cấp tên ngắn thay thế khi đọc lặp.",
  },
  {
    attr: "border",
    tag: "table",
    prompt: "Code cũ năm 2005 có <table ___=\"1\"> để hiện viền — thuộc tính lỗi thời nào (nay thay bằng CSS border)?",
    explain: "border trên table đã lỗi thời — dùng CSS.",
  },
  // ============ Đợt B: Cấu trúc trang mở rộng ============
  {
    attr: "lang",
    tag: "html",
    prompt: "Máy đọc màn hình đọc tiếng Việt bằng GIỌNG TIẾNG ANH nghe sai hết — thẻ <html> thiếu thuộc tính nào (giá trị vi)?",
    explain: '<html lang="vi"> giúp máy đọc chọn đúng giọng đọc.',
  },
  {
    attr: "lang",
    tag: "html",
    prompt: "Chrome cứ hiện popup 'Dịch trang này sang tiếng Anh?' dù trang là tiếng Việt chuẩn — khai báo thuộc tính nào để trình duyệt biết ngôn ngữ?",
    explain: "lang khai báo ngôn ngữ — trình duyệt và Google dựa vào đó.",
  },
  {
    attr: "lang",
    tag: "html",
    prompt: "Audit Lighthouse mục Accessibility trừ điểm: '<html> element does not have a [___] attribute'. Điền tên thuộc tính.",
    explain: "Thiếu lang là lỗi accessibility tiêu chuẩn của Lighthouse.",
  },
  {
    attr: "lang",
    tag: "html",
    prompt: "SEO đa quốc gia: bản tiếng Nhật của site khai báo <html ___=\"ja\"> để công cụ tìm kiếm phân vùng đúng.",
    explain: "lang trên html áp cho toàn trang.",
  },
  {
    attr: "dir",
    tag: "html",
    prompt: "Phiên bản tiếng Ả Rập của trang cần toàn bộ văn bản chạy từ PHẢI sang TRÁI (giá trị rtl).",
    explain: 'dir="rtl" đổi hướng đọc của cả trang.',
  },
  {
    attr: "charset",
    tag: "meta",
    prompt: "Trang hiện 'Tiáº¿ng Viá»‡t' thay vì 'Tiếng Việt' — dòng meta đầu <head> thiếu thuộc tính nào (giá trị UTF-8)?",
    explain: '<meta charset="UTF-8"> — thiếu là tiếng Việt vỡ font.',
  },
  {
    attr: "charset",
    tag: "meta",
    prompt: "Thuộc tính nào của <meta> đứng MỘT MÌNH (không cần name/content) và phải xuất hiện trong 1024 byte đầu của tài liệu?",
    explain: "charset — khai báo bảng mã càng sớm càng tốt.",
  },
  {
    attr: "charset",
    tag: "meta",
    prompt: "Checklist khởi tạo dự án: dòng meta ĐẦU TIÊN trong head luôn là khai báo bảng mã ký tự qua thuộc tính nào?",
    explain: "meta charset là dòng meta chuẩn đầu tiên của mọi trang.",
  },
  {
    attr: "content",
    tag: "meta",
    prompt: "<meta name=\"description\" ___=\"Giày chính hãng giá tốt\"> — đoạn mô tả hiện trên Google nằm trong thuộc tính nào?",
    explain: "content chứa giá trị của khai báo meta.",
  },
  {
    attr: "content",
    tag: "meta",
    prompt: "Meta viewport responsive: name=\"viewport\" đi cặp với thuộc tính nào chứa width=device-width, initial-scale=1?",
    explain: "name là tên khai báo, content là giá trị.",
  },
  {
    attr: "content",
    tag: "meta",
    prompt: "Trong mọi thẻ meta dạng cặp khóa–giá trị, phần GIÁ TRỊ luôn nằm ở thuộc tính nào?",
    explain: "content — bất kể khóa là name hay property.",
  },
  {
    attr: "name",
    tag: "meta",
    prompt: "Thuộc tính nào của <meta> giữ vai trò KHÓA của khai báo: viewport, description, robots, author...?",
    explain: 'name xác định loại metadata: <meta name="robots" content="noindex">.',
  },
  {
    attr: "name",
    tag: "meta",
    prompt: "Chặn Google index trang nội bộ: <meta ___=\"robots\" content=\"noindex\">.",
    explain: 'name="robots" — khai báo chỉ thị cho bot tìm kiếm.',
  },
  {
    attr: "property",
    tag: "meta",
    prompt: "Link share lên Facebook không hiện ảnh — cần thêm meta og:image, dùng thuộc tính nào làm khóa thay cho name?",
    explain: "Chuẩn Open Graph dùng property thay vì name.",
  },
  {
    attr: "property",
    tag: "meta",
    prompt: "<meta ___=\"og:title\" content=\"Sale 50%\"> — thuộc tính nào theo chuẩn Open Graph của mạng xã hội?",
    explain: "property là khóa của các thẻ og:*.",
  },
  {
    attr: "rel",
    tag: "link",
    prompt: "Thẻ <link href=\"style.css\"> KHÔNG áp dụng CSS vì thiếu thuộc tính khai báo vai trò 'stylesheet'. Thuộc tính nào?",
    explain: "Thiếu rel thì trình duyệt không biết file dùng làm gì.",
  },
  {
    attr: "rel",
    tag: "link",
    prompt: "Khai báo favicon: <link ___=\"icon\" href=\"/favicon.ico\">.",
    explain: 'rel="icon" — quan hệ của file với trang.',
  },
  {
    attr: "rel",
    tag: "link",
    prompt: "Tối ưu hiệu năng: báo trình duyệt TẢI TRƯỚC font quan trọng bằng <link ___=\"preload\" as=\"font\">.",
    explain: 'rel="preload" — một trong nhiều giá trị của rel trên link.',
  },
  {
    attr: "rel",
    tag: "link",
    prompt: "Thuộc tính nào của <link> nhận các giá trị: stylesheet, icon, preload, canonical, manifest?",
    explain: "rel quyết định trình duyệt làm gì với tài nguyên.",
  },
  {
    attr: "href",
    tag: "link",
    prompt: "Trong <link rel=\"stylesheet\">, ĐƯỜNG DẪN đến file CSS đặt ở thuộc tính nào?",
    explain: "link dùng href (giống a), không phải src.",
  },
  {
    attr: "sizes",
    tag: "link",
    prompt: "Khai báo 2 favicon 16x16 và 32x32 để trình duyệt tự chọn — kích thước ghi ở thuộc tính nào của link?",
    explain: 'sizes="32x32" mô tả kích thước icon.',
  },
  {
    attr: "media",
    tag: "link",
    prompt: "File CSS riêng cho DARK MODE chỉ tải khi hệ điều hành đang nền tối: <link ___=\"(prefers-color-scheme: dark)\">.",
    explain: "media trên link nhận media query — kể cả prefers-color-scheme.",
  },
  {
    attr: "integrity",
    tag: "link",
    prompt: "Nạp Bootstrap từ CDN, bảo mật yêu cầu trình duyệt TỪ CHỐI file nếu hash sha384 không khớp — thuộc tính nào?",
    explain: "integrity (SRI) chống CDN bị chèn mã độc.",
  },
  {
    attr: "crossorigin",
    tag: "link",
    prompt: "Thuộc tính nào (giá trị anonymous) phải đi kèm integrity khi nạp tài nguyên từ domain khác để CORS hoạt động?",
    explain: 'crossorigin="anonymous" — cặp bài trùng với integrity.',
  },
  {
    attr: "src",
    tag: "script",
    prompt: "<script>alert('hi')</script> chạy inline; muốn chuyển code ra file app.js riêng thì thêm thuộc tính nào?",
    explain: "script có src thì bỏ qua code inline bên trong.",
  },
  {
    attr: "src",
    tag: "script",
    prompt: "Console báo 404 main.js và trang mất hết tương tác — kiểm tra giá trị thuộc tính nào của thẻ <script>?",
    explain: "Đường dẫn sai trong src = script không tải được.",
  },
  {
    attr: "defer",
    tag: "script",
    prompt: "Script trong <head> đang CHẶN trang trắng đến khi tải xong — thêm thuộc tính nào để tải song song và chỉ chạy sau khi HTML parse hết?",
    explain: "defer không chặn render, chạy đúng thứ tự sau khi parse.",
  },
  {
    attr: "defer",
    tag: "script",
    prompt: "Script cần ĐỢI toàn bộ DOM sẵn sàng (document.querySelector tìm được mọi phần tử) mà không cần bọc DOMContentLoaded — thuộc tính nào?",
    explain: "defer đảm bảo DOM hoàn chỉnh khi script chạy.",
  },
  {
    attr: "defer",
    tag: "script",
    prompt: "Hai file a.js rồi b.js phụ thuộc nhau, vẫn muốn tải song song KHÔNG chặn trang nhưng phải chạy ĐÚNG THỨ TỰ — dùng async hay thuộc tính nào?",
    explain: "defer giữ thứ tự thực thi; async thì không.",
  },
  {
    attr: "defer",
    tag: "script",
    prompt: "Lighthouse gợi ý 'Eliminate render-blocking resources' cho script đầu trang — thuộc tính một chữ nào thường là cách sửa?",
    explain: "Thêm defer là cách sửa render-blocking phổ biến nhất.",
  },
  {
    attr: "async",
    tag: "script",
    prompt: "Script Google Analytics hoàn toàn ĐỘC LẬP, chạy lúc nào cũng được miễn là sớm — thuộc tính nào tải song song và chạy ngay khi xong?",
    explain: "async cho script độc lập không phụ thuộc thứ tự.",
  },
  {
    attr: "async",
    tag: "script",
    prompt: "Khác defer (đợi parse xong, giữ thứ tự), thuộc tính nào chạy NGAY khi tải xong, không quan tâm thứ tự?",
    explain: "async — nhanh nhất nhưng thứ tự không đảm bảo.",
  },
  {
    attr: "async",
    tag: "script",
    prompt: "Script quảng cáo bên thứ ba không được phép làm chậm trang và không script nào phụ thuộc nó — defer hay gì tốt hơn?",
    explain: "async là lựa chọn chuẩn cho script bên thứ ba độc lập.",
  },
  {
    attr: "type",
    tag: "script",
    prompt: "File JS dùng cú pháp import/export bị lỗi 'Cannot use import statement outside a module' — thẻ script thiếu thuộc tính nào (giá trị module)?",
    explain: 'type="module" bật ES modules (và tự defer).',
  },
  {
    attr: "type",
    tag: "script",
    prompt: "Nhúng dữ liệu JSON-LD cho SEO: <script ___=\"application/ld+json\"> — thuộc tính nào khai báo loại nội dung script?",
    explain: "type còn dùng cho JSON-LD, importmap... ngoài module.",
  },
  {
    attr: "nomodule",
    tag: "script",
    prompt: "Chiến lược 2 bản build: bản hiện đại type=module, bản cũ kèm thuộc tính nào để CHỈ trình duyệt cổ chạy?",
    explain: "nomodule — trình duyệt hiểu module sẽ bỏ qua file này.",
  },
  {
    attr: "onload",
    tag: "body",
    prompt: "Code cũ: <body ___=\"khoiTao()\"> chạy hàm khi trang tải xong — thuộc tính sự kiện nào (nay nên thay bằng addEventListener)?",
    explain: "onload inline đã lỗi thời — tách JS khỏi HTML.",
  },
  {
    attr: "aria-label",
    tag: "nav",
    prompt: "Trang có nav menu chính + nav breadcrumb + nav footer — người dùng máy đọc nghe 'navigation' ba lần không phân biệt được. Thêm gì cho mỗi nav?",
    explain: "aria-label đặt tên riêng: 'Menu chính', 'Breadcrumb'...",
  },
  {
    attr: "aria-label",
    tag: "button",
    prompt: "Nút chỉ có icon ❌ không có chữ — máy đọc màn hình cần một cái TÊN 'Đóng cửa sổ' qua thuộc tính nào?",
    explain: "aria-label đặt tên cho phần tử không có văn bản nhìn thấy.",
  },
  {
    attr: "aria-label",
    tag: "a",
    prompt: "Ba link cùng chữ 'Xem thêm' trỏ 3 bài khác nhau — phân biệt cho máy đọc màn hình ('Xem thêm về giày', ...) bằng thuộc tính nào?",
    explain: "aria-label ghi đè văn bản đọc lên của link.",
  },
  {
    attr: "aria-labelledby",
    tag: "section",
    prompt: "Vùng <section> muốn lấy chính heading con bên trong (id=\"km\") làm TÊN của vùng — thuộc tính ARIA nào trỏ theo id?",
    explain: "aria-labelledby trỏ đến id của phần tử chứa tên.",
  },
  // ============ Đợt B: Thuộc tính chung mở rộng ============
  {
    attr: "class",
    tag: "mọi thẻ",
    prompt: "CSS có sẵn .card và .featured — một sản phẩm nổi bật cần MANG CẢ HAI kiểu cùng lúc qua một thuộc tính.",
    explain: 'class="card featured" — nhiều lớp cách nhau khoảng trắng.',
  },
  {
    attr: "class",
    tag: "mọi thẻ",
    prompt: "JS cần chọn TẤT CẢ sản phẩm cùng loại bằng document.querySelectorAll('.san-pham') — các thẻ đó phải có chung thuộc tính nào?",
    explain: "class là cách nhóm nhiều phần tử cho CSS/JS xử lý hàng loạt.",
  },
  {
    attr: "class",
    tag: "mọi thẻ",
    prompt: "Khác id (duy nhất một phần tử), thuộc tính nào được phép LẶP LẠI trên nhiều phần tử và là nền tảng của mọi framework CSS?",
    explain: "class tái sử dụng được — Tailwind, Bootstrap đều xây trên nó.",
  },
  {
    attr: "class",
    tag: "mọi thẻ",
    prompt: "Dark mode bật bằng cách JS thêm 'dark' vào thuộc tính nào của thẻ <html> (element.classList.add)?",
    explain: "classList thao tác trực tiếp lên thuộc tính class.",
  },
  {
    attr: "id",
    tag: "mọi thẻ",
    prompt: "Link mục lục 'Chương 3' nhảy đến đúng vị trí giữa trang — phần tử đích phải có thuộc tính nào trùng với #chuong-3?",
    explain: "id là đích của anchor link #id.",
  },
  {
    attr: "id",
    tag: "mọi thẻ",
    prompt: "document.getElementById('gio-hang') tìm phần tử dựa trên thuộc tính nào?",
    explain: "id — định danh duy nhất để JS truy cập trực tiếp.",
  },
  {
    attr: "id",
    tag: "mọi thẻ",
    prompt: "Trang có HAI phần tử cùng mang một giá trị của thuộc tính này khiến label for và getElementById hoạt động sai — thuộc tính nào phải duy nhất?",
    explain: "id trùng lặp là HTML không hợp lệ và gây bug khó lần.",
  },
  {
    attr: "id",
    tag: "mọi thẻ",
    prompt: "label dùng for=\"email\" — ô input tương ứng phải mang thuộc tính nào giá trị email?",
    explain: "Cặp for (label) ↔ id (input).",
  },
  {
    attr: "style",
    tag: "mọi thẻ",
    prompt: "Email HTML không nạp được file CSS ngoài — mọi định dạng phải viết INLINE trên từng thẻ qua thuộc tính nào?",
    explain: "Email client chỉ tin style inline — ngoại lệ hợp lý của style.",
  },
  {
    attr: "style",
    tag: "mọi thẻ",
    prompt: "JS đổi màu nền một phần tử ngay lập tức: el.___.background = 'red' — thuộc tính nào?",
    explain: "element.style thao tác CSS inline từ JS.",
  },
  {
    attr: "title",
    tag: "mọi thẻ",
    prompt: "Nút bị disabled cần giải thích 'Hết hàng — không thể đặt' hiện ra khi NGƯỜI DÙNG RÊ CHUỘT lên.",
    explain: "title hiện tooltip mặc định của trình duyệt.",
  },
  {
    attr: "title",
    tag: "abbr",
    prompt: "Chữ viết tắt 'W3C' cần bản đầy đủ 'World Wide Web Consortium' hiện khi hover — thuộc tính chuẩn của thẻ <abbr>?",
    explain: "abbr + title là cặp chuẩn cho chữ viết tắt.",
  },
  {
    attr: "hidden",
    tag: "mọi thẻ",
    prompt: "Modal 'Xác nhận xóa' nằm sẵn trong HTML nhưng PHẢI VÔ HÌNH cho đến khi JS gỡ một thuộc tính boolean.",
    explain: "hidden ẩn phần tử không cần viết CSS.",
  },
  {
    attr: "hidden",
    tag: "mọi thẻ",
    prompt: "Khác CSS visibility (vẫn chiếm chỗ), thuộc tính HTML nào làm phần tử biến mất hoàn toàn như display:none?",
    explain: "hidden tương đương display:none — không chiếm không gian.",
  },
  {
    attr: "data-*",
    accept: ["data"],
    prefix: true,
    tag: "mọi thẻ",
    prompt: "Nút 'Thêm vào giỏ' cần mang theo mã sản phẩm SP042 để JS đọc khi click — nhóm thuộc tính tùy biến nào (đọc qua el.dataset)?",
    explain: "data-product-id=\"SP042\" → el.dataset.productId.",
  },
  {
    attr: "data-*",
    accept: ["data"],
    prefix: true,
    tag: "mọi thẻ",
    prompt: "Cần lưu trạng thái 'đã thích' ngay trên thẻ HTML mà không bịa thuộc tính sai chuẩn — HTML5 dành riêng nhóm tiền tố nào cho dữ liệu tùy ý?",
    explain: "Mọi thuộc tính data-* đều hợp lệ — chỗ chứa dữ liệu cho JS.",
  },
  {
    attr: "tabindex",
    tag: "mọi thẻ",
    prompt: "Card sản phẩm làm bằng <div> có onClick nhưng người dùng BÀN PHÍM không Tab tới được — thêm thuộc tính nào giá trị 0?",
    explain: 'tabindex="0" đưa phần tử thường vào chuỗi focus.',
  },
  {
    attr: "contenteditable",
    tag: "mọi thẻ",
    prompt: "Tính năng 'sửa tiêu đề tại chỗ': click vào <h2> là gõ sửa được ngay như ô nhập — thuộc tính nào?",
    explain: "contenteditable biến mọi phần tử thành vùng soạn thảo.",
  },
];
