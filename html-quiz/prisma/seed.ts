...
export const tags: SeedTag[] = [
  ...
  },
  {
    ...
    questions: [
      ...
      {
        tier: 2, type: T.MCQ,
        prompt: "Giá trị của thuộc tính nên đặt trong gì để tránh lỗi (nhất là khi giá trị có khoảng trắng)?",
      ...
      },
      {
        ...
        requirements: [
          ...
          { type: "attr", name: "src", value: "banner.jpg" },
        ],
      },
    ],
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        options: ["Dòng chữ không hiện đúng chỗ trong lòng trang — head không dành cho nội dung hiển thị", "Trang đẹp hơn vì head được ưu tiên hiển thị", "Máy tính báo virus", "File tự động đổi đuôi thành .txt"],
        correctIndex: 0,
      },
      {
        tier: 2, type: T.MCQ,
